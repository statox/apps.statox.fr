    ...
    apps: [
        {
            name: 'Sudoku',
            description:
                'A classic Sudoku game. Grids are generated automatically.',
            link: 'https://statox.github.io/sudoku/game'
        },
        {
            name: 'Tic Tac Wow',
            description:
                'Tic Tac Toe and different variants with AI opponents.',
            link: 'https://statox.github.io/tic-tac-wow/'
        },
        {
            name: '2048',
            description:
                'The famous puzzle game from 2014.',
            link: 'https://statox.github.io/2048/'
        },
        {
            name: 'Reversi',
            description:
                'A two players strategy board game with an AI opponent.',
        ...
        },
        {
            name: 'Asteroides',
            description:
                'The old arcade game with a spaceship destroyins space rocks.',
